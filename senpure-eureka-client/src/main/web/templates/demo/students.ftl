    ...
    <#include "../menu.ftl">
        <div class="col-sm-10 "> <!--center col-sm-10 start -->
            ...
            <#if code??&&code!=1 >
                ...
                <input type="hidden" name="datePattern" value="${criteria.datePattern!"HH:mm:ss yyyy/MM/dd"}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="endDate" name="endDate" class="form-control"
                               data-date-format="hh:ii:ss yyyy/mm/dd"
                               data-date-language="${viewLocale!"zh-CN"}" data-min-view="1" datetimepicker-receive="yes"
                               data-date-type="end"
                ...
                <div class="form-group ">
                    <button class="btn btn-success pull-right faa-parent animated-hover " modal-button="true">
        ...
        <#if total??&&items??>
            <#if total gt 0&&(items?size>0)>
                <form id="criteria-pagination" action="/demo/students"
                      method="post" modal-form="true"
                      class="form-inline"
